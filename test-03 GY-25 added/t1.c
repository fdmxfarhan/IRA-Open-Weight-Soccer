...
void print(int var)
    ...
    if(var>=0)
        {                             
        lcd_putchar('+');
        lcd_putchar((var/100)%10+'0');
        lcd_putchar((var/10)%10+'0');
        lcd_putchar((var/1)%10+'0'); 
        }
    else
        {                             
        lcd_putchar('-');
...
void read_pixy()
    ...
    lcd_gotoxy(5,0);
    lcd_putchar('G');
    lcd_putchar((goal/10)%10+'0');
    lcd_putchar((goal/1)%10+'0');
...
while (1)
    ...
    kick_sen = read_adc(0);     
    lcd_gotoxy(5,1);
    lcd_putchar((kick_sen/1000)%10+'10');
    lcd_putchar((kick_sen/100)%10+'10');
    lcd_putchar((kick_sen/10)%10+'10');
    lcd_putchar((kick_sen/1)%10+'10');
    if(kick_sen<400)
        {                        
        PORTB.4 = 1;
        if(!is_goal)  motor(-150,-150,150,150);      
        else if(goal_distance<70)    
            { 
            cmp = 0;
        ...
        if(ball_distance < 90) 
            ...
            PORTB.4 = 1;
            if(ball == 0)       move(ball);
            else if(ball == 1)  move(2);
            else if(ball == 15) move(14);
            else if(ball == 2)  move(4);
            else if(ball == 14) move(12);
